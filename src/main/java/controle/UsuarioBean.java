...
public class UsuarioBean {
		...
		if (!modoEdicao) {
			if (usuarioDAO.existeUsuario(usuario) == null) {
				...
				FacesContext.getCurrentInstance().addMessage(null,
						new FacesMessage(FacesMessage.SEVERITY_INFO, usuario.getNome(), " inserido com sucesso"));
			} else {
				FacesContext.getCurrentInstance().addMessage(null,
			...
			FacesContext.getCurrentInstance().addMessage(null,
					new FacesMessage(FacesMessage.SEVERITY_INFO, "Sucesso", "Usuário alterado com sucesso"));
		}
	}
	...
	public void removerTelefone() {
		...
		for (Telefone cont : usuario.getListaTelefones()) {
			if (numeroSel != null && !numeroSel.isEmpty()) {
